...
<template>
  <main>
    ...
    <div v-if="principal && userData">
      ...
      <div>
        <textarea v-model="newChat" placeholder="wiadomosc"></textarea><button @click="dodajChatMSG">Dodaj wiadomosc</button>
      </div>
    </div>
  </main>
</template>